...
try:
    ...
    font24 = ImageFont.truetype(os.path.join(picdir, '/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf'), 24)
    font18 = ImageFont.truetype(os.path.join(picdir, '/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf'), 18)
    font35 = ImageFont.truetype(os.path.join(picdir, '/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf'), 35)
    ...
    Himage = Image.open('GALLERY/black/asd.jpg')
    epd.display(epd.getbuffer(Himage))
    time.sleep(2)
